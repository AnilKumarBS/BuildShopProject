...
public class VerificationLibrary {
	...
	public static void verifyPetProfileCompletionColor(WebDriver driver, String sectionName, String expectedColor){
		...
		String[] classAttrValue = driver.findElement(By.xpath(xpth)).getAttribute("class").split(" ");
		String completionValue = classAttrValue[classAttrValue.length-1];
		
		HashMap<String, String> colorMap = new HashMap<String, String>();
		colorMap.put("not-filled","red");
		colorMap.put("partially-filled","yellow");
		colorMap.put("completely-filled","green");

		Assert.assertEquals(colorMap.get(completionValue), expectedColor);
	}
	
	public static void verifyVaccinationColor(WebDriver driver, int rowNum, String expectedColor){
		String xpth = "//table[contains(@class,'vaccination-table')]/tbody/tr["+rowNum+"]";
		String classAttrValue = driver.findElement(By.xpath(xpth)).getAttribute("class");				
		
		HashMap<String, String> colorMap = new HashMap<String, String>();
		colorMap.put("ng-scope","white");
		colorMap.put("ng-scope expired","red");
		colorMap.put("ng-scope justExpired","yellow");
		colorMap.put("ng-scope aboutToExpire","lemon");				
		Assert.assertEquals(colorMap.get(classAttrValue), expectedColor);
	}
