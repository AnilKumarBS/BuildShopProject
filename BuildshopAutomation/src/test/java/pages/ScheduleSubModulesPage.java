...
public WebDriver driver;
    ...
    public ScheduleSubModulesPage(WebDriver driver)
    {
        this.driver=driver;
    ...
    @FindBy(xpath="//div[@id='ctl00_MainContent_FormViewProjectPlanInsert_CalendarExtenderStart1_day_1_1']")
    public WebElement startdate; 
    
    @FindBy(xpath="//input[@id='ctl00_MainContent_FormViewProjectPlanInsert_ProjectPlanFinishTextBox']")
    public WebElement finish; 
    
    @FindBy(xpath="//div[@id='ctl00_MainContent_FormViewProjectPlanInsert_CalendarExtender1_day_2_1']")
    ...
    @FindBy(xpath="//span[contains(text(),'Doors Type')]/../..//td[1]//img")
    public WebElement editicon; 
    
    @FindBy(xpath="//input[@name='ctl00$MainContent$GridView1$ctl02$btnViewDetailsProjectPlanStep']")
...
//		Thread.sleep(2000);
    	...
    	act2.moveToElement(editicon1).click().perform();
